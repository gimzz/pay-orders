...
16	23342	asdsdasf	sfdadfsa	341212	\N
\.
...
12	pollo	pollo congelado	kg	20	5
\.
...
17	12	ENTRADA	20	Stock inicial	2025-09-10 19:58:56.144006
\.
...
SELECT pg_catalog.setval('system.clientes_id_seq', 16, true);
...
SELECT pg_catalog.setval('system.materia_prima_id_seq', 12, true);
...
SELECT pg_catalog.setval('system.movimientos_materia_prima_id_seq', 17, true);
...
SELECT pg_catalog.setval('system.productos_id_seq', 16, true);
...
SELECT pg_catalog.setval('system.tasa_cambio_id_seq', 8, true);
